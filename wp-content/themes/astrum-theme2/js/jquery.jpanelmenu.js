    ...
    var jP = {
      ...
      setjPanelMenuStyles: function () {
        ...
        if ($("#jPanelMenu-style-master").length == 0) {
          $("body").append(
            '<style id="jPanelMenu-style-master">@media only screen and (max-width: ' +
              astrum.breakpoint +
              "px) { body{width:100%}.jPanelMenu,body{/* overflow-x:hidden  pidor*/}#jPanelMenu-menu{display:block;position:fixed;top:0;" +
      ...
      openMenu: function (animated) {
        ...
        $("<div>", { class: "backdrop" }).appendTo(".jPanelMenu-panel");
        setTimeout(() => $(".backdrop").addClass("backdrop--active"), 0);
        /*end for new menu*/
        jP.clearTimeouts();
