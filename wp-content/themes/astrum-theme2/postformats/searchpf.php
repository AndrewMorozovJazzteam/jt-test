  ...
  <article <?php post_class('post medium search-blog-post-container '.$format); ?> id="post-<?php the_ID(); ?>" >
    <?php
...
<!--   <div class="post-format">
  ...
  <?php } ?>
    <section class="post-content">
      ...
      <header class="meta">
        <a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'purepress'), the_title_attribute('echo=0')); ?>" rel="bookmark"><h2 class="headline-third" >
          <?php the_title(); ?>
        </h2></a>
