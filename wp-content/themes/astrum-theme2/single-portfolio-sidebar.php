  ...
  <section id="titlebar">
    ...
    <div class="container">
      ...
      <div class="eight columns">
        <h1 class="portfolio-title-head"><?php the_title(); ?> <?php $subtitle  = get_post_meta($post->ID, 'pp_subtitle', true);
        if ( $subtitle) {
...
<?php  if(ot_get_option('pp_related_pf') != 'hide') { ?>
  ...
  <div class="container" id="pf-contact-form">
 		<?php echo do_shortcode('[template id="11118"]'); ?> 
  </div>
<?php
}
get_footer();
